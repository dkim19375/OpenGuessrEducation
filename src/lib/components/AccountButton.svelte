...
{#if !isLoggedIn}
    <button class="btn btn-accent" onclick={showModal}>Log in
        <LogIn/>
    </button>
{/if}
...
<dialog class="modal h-full w-[calc(100vw-1rem)] mx-2 p-0" id="login_modal">
    <dialog class="modal" id="my_modal_2"></dialog>
    <div class="modal-box h-[98%] max-h-full w-full p-0 bg-base-200">
        ...
        : 'opacity-0'} transition-opacity duration-500"
                ...
                title="Login and Sign up"></iframe>
    </div>
</dialog>
